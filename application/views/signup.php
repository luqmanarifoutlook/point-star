                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                            <div class="login-page bg-white shadow rounded p-4 position-relative">
                                ...
                                <form class="login-form mt-4" action="<?php echo base_url('register'); ?>">
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 login-footer">
                                            <p class="mb-0 mt-3"><small class="text-dark mr-2">Already have an account ?</small> <a href="<?php echo base_url('login'); ?>" class="text-dark font-weight-bold">Login</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
